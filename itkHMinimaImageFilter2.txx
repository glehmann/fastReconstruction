...
#include "itkMorphologicalReconstructionErosionImageFilter.h"
...
::GenerateData()
{
  ...
  //
  //
  typename MorphologicalReconstructionErosionImageFilter<TInputImage, TInputImage>::Pointer
    erode
    = MorphologicalReconstructionErosionImageFilter<TInputImage, TInputImage>::New();
